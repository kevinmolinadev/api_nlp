...
def extract_keywords(text):
    ...
    omit_words = omit_words = ['claro', 'unos', 'unas', 'cómo', 'cuándo', 'cuál', 'cuáles', 'quién', 'tengo', 'llamo', 'llame', 'estar', 'tener', 'encuentra', 'tiene', 'cuántos', 'cuántas', 'quiénes', 'este', 'para', 'podamos', 'todos', 'cuantas', 'cuales', 'solo', 'quiero']
